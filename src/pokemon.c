...
u32 GetBoxMonData(struct BoxPokemon *boxMon, s32 field, u8 *data)
{
    ...
    case MON_DATA_GIFT_RIBBON_5:
        retVal = boxMon->giftRibbon5;
        break;
    case MON_DATA_GIFT_RIBBON_6:
        retVal = boxMon->giftRibbon6;
        break;
    case MON_DATA_GIFT_RIBBON_7:
        retVal = boxMon->giftRibbon7;
        break;
    ...
    case MON_DATA_RIBBONS:
        ...
        if (boxMon->species && !boxMon->isEgg)
        {
            retVal = boxMon->championRibbon
                ...
                | (boxMon->giftRibbon5 << 24)
                | (boxMon->giftRibbon6 << 25)
                | (boxMon->giftRibbon7 << 26);
        }
        break;
    default:
        break;
...
void SetBoxMonData(struct BoxPokemon *boxMon, s32 field, const void *dataArg)
{
    ...
    case MON_DATA_GIFT_RIBBON_4:
        ...
        break;
    case MON_DATA_GIFT_RIBBON_5:
        SET8(boxMon->giftRibbon5);
        break;
    case MON_DATA_GIFT_RIBBON_6:
        SET8(boxMon->giftRibbon6);
        break;
    case MON_DATA_GIFT_RIBBON_7:
        SET8(boxMon->giftRibbon7);
        break;
    case MON_DATA_FATEFUL_ENCOUNTER:
                    ...
                    case 3:
                            ...
                            for (r5 = 0; (signed)(r5) < (signed)(4); r5++)
                            {
                                ...
                                if (dataUnsigned != CalculatePPWithBonus(moveId, GetMonData(mon, MON_DATA_PP_BONUSES, NULL), r5))
                                {
                                    ...
                                    if (gMain.inBattle
                                     ...
                                     && !(gBattleMons[battlerId].disableStruct.mimickedMoves & gBitTable[r5]))
                        ...
                        else
                        {
                            ...
                            if (dataUnsigned != CalculatePPWithBonus(moveId, GetMonData(mon, MON_DATA_PP_BONUSES, NULL), moveIndex))
                            {
                                ...
                                if (gMain.inBattle
                                 && battlerId != 4 && !(gBattleMons[battlerId].status2 & STATUS2_TRANSFORMED)
                                 && !(gBattleMons[battlerId].disableStruct.mimickedMoves & gBitTable[moveIndex]))
