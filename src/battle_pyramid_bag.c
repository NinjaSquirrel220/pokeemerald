...
static void PrintOnWindow_Font1(u8 windowId, const u8 *src, u8 x, u8 y, s8 letterSpacing, u8 lineSpacing, u8 speed, u8 colorTableId);
static void PrintOnWindow_Font7(u8 windowId, const u8 *src, u8 x, u8 y, s8 letterSpacing, u8 lineSpacing, u8 speed, u8 colorTableId);
