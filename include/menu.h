...
void AddTextPrinterParameterized4(u8 windowId, u8 fontId, u8 x, u8 y, s8 letterSpacing, u8 lineSpacing, const u8 *color, s8 speed, const u8 *str);
void AddTextPrinterParameterizedHPBox(u8 windowId, u8 fontId, u8 x, u8 y, s8 letterSpacing, u8 lineSpacing, const u8 *color, s8 speed, const u8 *str);
